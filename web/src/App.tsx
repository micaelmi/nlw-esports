              ...
              <div className="flex gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-center gap-2">
                    <WeekDayButton title="Domingo" initial="D" />
                    <WeekDayButton title="Segunda" initial="S" />
                    <WeekDayButton title="Terça" initial="T" />
                    <WeekDayButton title="Quarta" initial="Q" />
                  </div>
                  <div className="flex justify-center gap-2">
                    <WeekDayButton title="Quinta" initial="Q" />
                    <WeekDayButton title="Sexta" initial="S" />
                    <WeekDayButton title="Sábado" initial="S" />
                  </div>
                </div>
